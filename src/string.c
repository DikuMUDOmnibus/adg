...
void string_append( CHAR_DATA *ch, char **pString )
{
    ...
    send_to_char( " Terminate with a ~ or @ on a blank line.\n\r", ch );
    send_to_char( " Becareful with the long Room Desciptions,\n\r", ch );
    send_to_char( " Depending on your allocated memory usage\n\r", ch );
    send_to_char( " The mud may crash when you look.\n\r", ch);
    send_to_char( "-=======================================-\n\r", ch );
